...
//     const users = [
//       { email: 'user1@example1.com', name: 'User One' },
//       { email: 'user2@example1.com', name: 'User Two' }
//     ]
...
//       email: { 
//         $in: ['user1@example1.com', 'user2@example1.com']
//       }
//     })
//   }
// }
...
export async function up(connection: Connection) {
  // Add your migration logic here
  const users = [
    { email: 'user3@example1.com', name: 'User One' },
    { email: 'user4@example1.com', name: 'User Two' }
  ]
...
export async function down(connection: Connection) {
  ...
  await connection.collection('users').deleteMany({
    email: { 
      $in: ['user3@example1.com', 'user4@example1.com']
    }
  })
